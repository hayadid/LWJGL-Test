...
public class DrawTwoTexturedCubes {
    ...
    private void init() {
        ...
        window = glfwCreateWindow(800, 600, "Two Textured Cubes", NULL, NULL);
        if (window == NULL) {
        ...
        while (!glfwWindowShouldClose(window)) {
            ...
            for (int i = 0; i < 3; i++) {
                ...
                Matrix4f model1 = new Matrix4f()
                        .translate(-1.0f + i, 0.0f, 0.0f) // Move the first cube to the left
                        .rotateX(angleX)
                        .rotateY(angleY);
